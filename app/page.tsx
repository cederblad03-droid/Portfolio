...
export default function Home() {
  return (
    <>
      ...
      <main className="min-h-screen flex items-start justify-center py-24 px-6">
        <div className="w-full max-w-6xl flex flex-col md:flex-row items-start gap-12">
          <aside className="w-full md:w-1/4 flex flex-col items-center gap-8">
            <div className="w-56 h-56 rounded-md overflow-hidden border-0 shadow-xl">
          ...
          <section className="w-full md:w-3/4">
            <div className="card p-8 min-h-[260px]">
              <h1 className="text-3xl md:text-4xl font-bold mb-3">Dominic Cederblad - Program Developer</h1>
